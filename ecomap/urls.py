...
urlpatterns = patterns(
    ...
    url(r'^game/(?P<map_id>\d+)/$', views.get_map, name='get_map'),
    url(r'^game/(?P<map_id>\d+)/display/flashConduit$', views.display, name='display'),
    #url(r'^game/display/flashConduit$', views.display, name='display'),
