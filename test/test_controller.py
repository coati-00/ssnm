## i've disabled this test for the time being.
## i haven't yet figured out how to properly stub
## out controller tests with the newest version of
## cherrypy. once i figure that out, we can reenable this
## test.        --anders
